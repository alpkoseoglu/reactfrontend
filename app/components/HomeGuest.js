    ...
    switch (action.type) {
      case "usernameImmediately":
        ...
        if (draft.username.value.length > 30) {
          ...
          draft.username.message = "Username cannot be more than 30 characters."
        }
      ...
      case "usernameUniqueResults":
        if (action.value) {
          ...
          draft.username.message = "This username already taken."
        } else {
      ...
      case "emailAfterDelay":
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = "You must provide valid email address."
        }
      ...
      case "emailUniqueResults":
        if (action.value) {
          ...
          draft.email.message = "This email already being used."
        } else {
      ...
      case "passwordImmediately":
        ...
        if (draft.password.value.length > 50) {
          ...
          draft.password.message = "Password cannot be more than 50 characters."
        }
        break
